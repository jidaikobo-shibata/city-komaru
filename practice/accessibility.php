...
<?php if ($minus_year == 1):  ?>
<p><?php echo $this_year ?>年の試験では、JIS X 8341-3:2016適合レベルAAの試験を行い、地球温暖化防止のページすべてについて、基準を満たしている状態であることを確認できました。また、AAよりもさらに上の基準を目指すために、レベルAAAの基準についても試験を行いました。（「<a href="#additional-criteria">追加するAAAの達成基準</a>」参照）</p>
...
<tr>
	<th>満たしている適合レベル</th>
	<td><?php if ($minus_year == 3): ?>A一部準拠<?php elseif ($minus_year == 2): ?>AA一部準拠<?php else: ?>AA準拠<?php endif; ?>
</td>
</tr>
<tr>
...
<tr>
	...
	<td>HTML / CSS / JavaScript<?php if ($minus_year == 1): ?> / PDF<? endif; ?></td>
</tr>
<tr>
	<th>試験実施期間</th>
